...
public class MaskTesting {
	...
	public void testOperations() {
		...
		System.out.println("1: "+ Integer.toBinaryString(domainAPI.getMask(fileUID)));

		domainAPI.queueOperation(DomainAPI.Operation.COPY_TO_LOCAL, fileUID);
		System.out.println("2: "+Integer.toBinaryString(domainAPI.getMask(fileUID)));

		domainAPI.queueOperation(DomainAPI.Operation.COPY_TO_LOCAL, fileUID);
		System.out.println("3: "+Integer.toBinaryString(domainAPI.getMask(fileUID)));

		domainAPI.queueOperation(DomainAPI.Operation.COPY_TO_SERVER, fileUID);
		System.out.println("4: "+Integer.toBinaryString(domainAPI.getMask(fileUID)));

		domainAPI.queueOperation(DomainAPI.Operation.REMOVE_FROM_LOCAL, fileUID);
		System.out.println("5: "+Integer.toBinaryString(domainAPI.getMask(fileUID)));
	}
}
